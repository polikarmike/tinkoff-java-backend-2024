...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @NotNull OffsetDateTime value3, @Nullable OffsetDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @NotNull OffsetDateTime createdAt, @Nullable OffsetDateTime lastUpdatedAt) {
        super(Link.LINK);
