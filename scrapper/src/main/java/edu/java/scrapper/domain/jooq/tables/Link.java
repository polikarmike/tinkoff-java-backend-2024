...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> URL = createField(DSL.name("URL"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINK.CREATED_AT</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("CREATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
